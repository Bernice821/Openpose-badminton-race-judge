...
courtdf=court_superglue.court_superglue(args.video_file)
success = True
frame_count = 0
num_final_frame = 0
ratio = h / HEIGHT
...
#ShotSeq,HitFrame,Hitter,RoundHead,Backhand,BallHeight,LandingX,LandingY,HitterLocationX,HitterLocationY,DefenderLocationX,DefenderLocationY,BallType,Winner
...
while cap.isOpened():
    ...
    if frame_count in final_predict:  # 每两帧图像才处理一次
        ...
        if frame_count==final_predict[-1]:
            winner=winner_detection.caculatewinner(courtdf,(ball_x,ball_y))
